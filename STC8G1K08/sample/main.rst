      ...
      000000                        138 	.org 0x0000
                           ...
                           0000B2   165 _P3M0	=	0x00b2
                           0000B1   166 _P3M1	=	0x00b1
                                    167 ;--------------------------------------------------------
      ...
      000000 02 00 4C         [24]  329 	ljmp	__sdcc_gsinit_startup
      ...
      0000A5 02 00 49         [24]  402 	ljmp	__sdcc_program_startup
                                    403 ;--------------------------------------------------------
                                    404 ; Home
                                    405 ;--------------------------------------------------------
                                    406 	.area HOME    (CODE)
      ...
      000049 02 00 CC         [24]  409 	ljmp	_main
                                    ...
                                    414 	.area CSEG    (CODE)
                                    415 ;------------------------------------------------------------
                                    416 ;Allocation info for local variables in function 'delay'
                                    417 ;------------------------------------------------------------
                                    418 ;i             Allocated to registers r7 
                                    419 ;j             Allocated to registers r5 r6 
                                    420 ;k             Allocated to registers r3 r4 
                                    421 ;------------------------------------------------------------
                                    422 ;	main.c:6: void delay(void)
                                    423 ;	-----------------------------------------
                                    424 ;	 function delay
                                    425 ;	-----------------------------------------
      0000A8                        426 _delay:
                           ...
                           000001   433 	ar1 = 0x01
                           000000   434 	ar0 = 0x00
                                    435 ;	main.c:9: for(i=0;i<8;i++)
      0000A8 7F 00            [12]  436 	mov	r7,#0x00
                                    437 ;	main.c:10: for(j=0;j<256;j++)
      0000AA                        438 00115$:
      0000AA 7D 00            [12]  439 	mov	r5,#0x00
      0000AC 7E 00            [12]  440 	mov	r6,#0x00
                                    441 ;	main.c:11: for(k=0;k<256;k++);
      0000AE                        442 00113$:
      0000AE 7B 00            [12]  443 	mov	r3,#0x00
      0000B0 7C 01            [12]  444 	mov	r4,#0x01
      0000B2                        445 00106$:
      0000B2 1B               [12]  446 	dec	r3
      0000B3 BB FF 01         [24]  447 	cjne	r3,#0xff,00146$
      0000B6 1C               [12]  448 	dec	r4
      0000B7                        449 00146$:
      0000B7 EB               [12]  450 	mov	a,r3
      0000B8 4C               [12]  451 	orl	a,r4
      0000B9 70 F7            [24]  452 	jnz	00106$
                                    453 ;	main.c:10: for(j=0;j<256;j++)
      0000BB 0D               [12]  454 	inc	r5
      0000BC BD 00 01         [24]  455 	cjne	r5,#0x00,00148$
      0000BF 0E               [12]  456 	inc	r6
      0000C0                        457 00148$:
      0000C0 74 FF            [12]  458 	mov	a,#0x100 - 0x01
      0000C2 2E               [12]  459 	add	a,r6
      0000C3 50 E9            [24]  460 	jnc	00113$
                                    461 ;	main.c:9: for(i=0;i<8;i++)
      0000C5 0F               [12]  462 	inc	r7
      0000C6 BF 08 00         [24]  463 	cjne	r7,#0x08,00150$
      0000C9                        464 00150$:
      0000C9 40 DF            [24]  465 	jc	00115$
                                    466 ;	main.c:12: }
      0000CB 22               [24]  467 	ret
                                    468 ;------------------------------------------------------------
                                    469 ;Allocation info for local variables in function 'main'
                                    470 ;------------------------------------------------------------
                                    471 ;	main.c:14: void main(void)
                                    472 ;	-----------------------------------------
                                    473 ;	 function main
                                    474 ;	-----------------------------------------
      0000CC                        475 _main:
                                    476 ;	main.c:16: P3M0 = 0x00;   // quasi mode
      0000CC 75 B2 00         [24]  477 	mov	_P3M0,#0x00
                                    478 ;	main.c:17: P3M1 = 0x00;
      0000CF 75 B1 00         [24]  479 	mov	_P3M1,#0x00
                                    480 ;	main.c:19: while(1)
      0000D2                        481 00102$:
                                    482 ;	main.c:21: P3_3 = 0;
                                    483 ;	assignBit
      0000D2 C2 B3            [12]  484 	clr	_P3_3
                                    485 ;	main.c:22: delay();
      0000D4 12 00 A8         [24]  486 	lcall	_delay
                                    487 ;	main.c:23: P3_3 = 1;
                                    488 ;	assignBit
      0000D7 D2 B3            [12]  489 	setb	_P3_3
                                    490 ;	main.c:24: delay();
      0000D9 12 00 A8         [24]  491 	lcall	_delay
                                    492 ;	main.c:26: }
      0000DC 80 F4            [24]  493 	sjmp	00102$
                                    494 	.area CSEG    (CODE)
                                    495 	.area CONST   (CODE)
                                    496 	.area XINIT   (CODE)
